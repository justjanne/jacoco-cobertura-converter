...
data class ReportDto(
  ...
  val name: String,
  @field:JacksonXmlProperty(isAttribute = false, localName = "sessioninfo")
  @field:JacksonXmlElementWrapper(useWrapping = false, localName = "sessioninfo")
  val sessionInfos: List<SessionInfoDto>?,
